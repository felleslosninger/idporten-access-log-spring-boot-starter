...
class AccessLogsConfigurationTest {
    ...
    @Test
    void useExternalConfigFileWhenDebugSet() {
        AccessLogsConfiguration config = new AccessLogsConfiguration();
    ...
    @Test
    void useDebugRequestFileWhenDebugSetAndNoExternalConfig() {
        AccessLogsConfiguration config = new AccessLogsConfiguration();
    ...
    @Test
    void useDebugResponseFileWhenDebugSetAndNoExternalConfig() {
        AccessLogsConfiguration config = new AccessLogsConfiguration();
